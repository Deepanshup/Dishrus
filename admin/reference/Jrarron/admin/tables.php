<!DOCTYPE html>
<head>
<title>Jrarron | Route List</title>
		...
		<div class="main-grid">
			...
			<h3>Driving</h3>
						...
						<tbody>
                            ...
                            $password = "root@123";
                            $dbname = "nadaa93i_Jrarron";
                          function accept($pl,$rt,$cat,$imgn,$abt,$poi,$ID,$sr,$ds,$audio) {
                                $_SESSION['place'] = $pl;
                                $_SESSION['rating'] = $rt;
                                ...
                                $_SESSION['ID'] = $ID;
                                $_SESSION['source'] = $sr;
                                $_SESSION['destination'] = $ds;
                                $_SESSION['poiAudio'] = $audio;
                                $_SESSION["end"]="true";
                                echo '<script>
                        ...
                        function reject($un,$bn,$ID) {
                            ...
                            try {
                                    ...
                                    $sq = "DELETE FROM admin WHERE route_id='$ID'";
                                    if($co->query($sq)){
                                    $_SESSION["end"]="true";
                                    echo '<script>
                                        window.location="tables.php";
                            ...
                            try {
                                    ...
                                    while($row=mysqli_fetch_row($results)){
                                        ...
                                        $six=urldecode($row[2]);
                                        $seven=urldecode($row[7]);
                                        $nine=urldecode($row[9]);
                                        $ten=urldecode($row[10]);
                                        $s=$one.'*'.$six.'*'.$row[3].'*'.$two.'*'.$four.'*'.$five.'*'.$row[8].'*'.$nine.'*'.$ten.'*'.$seven;
                                    echo "
                                    <tr>
                                        <td>$one</td>
								    ...
								    {              
								        ...
								        accept($onee[0],$onee[3],$onee[1],$onee[2],$onee[4],$onee[5],$onee[6],$onee[7],$onee[8],$onee[9]);
								        
								    }
								    if(isset($_POST["reject"]))
								    {
								        $onee=explode('*', $_POST["reject"]);
								        reject($onee[0],$onee[1],$onee[6]);
				...
				<h3>Bike</h3>
						...
						<tbody>
                            ...
                            $password = "root@123";
                            $dbname = "nadaa93i_Jrarron";
                          function acceptBike($pl,$rt,$cat,$imgn,$abt,$poi,$ID,$sr,$ds,$audio) {
                                $_SESSION['place'] = $pl;
                                $_SESSION['rating'] = $rt;
                                $_SESSION['category'] = $cat;
                                $_SESSION['image_name'] = $imgn;
                                ...
                                $_SESSION['ID'] = $ID;
                                $_SESSION['source'] = $sr;
                                $_SESSION['destination'] = $ds;$_SESSION['poiAudio'] = $audio;
                                $_SESSION["end"]="true";
                                echo '<script>
                                    window.location="edit_route.php";
                                </script>';
                        ...
                        function rejectBike($un,$bn,$ID) {
                            ...
                            try {
								    ...
								    {              
								        $onee=explode('*', $_POST["accept"]);
								        acceptBike($onee[0],$onee[3],$onee[1],$onee[2],$onee[4],$onee[5],$onee[6],$onee[7],$onee[8],$onee[9]);
								        
								    }
								    if(isset($_POST["reject"]))
								    {
								        $onee=explode('*', $_POST["reject"]);
								        rejectBike($onee[0],$onee[1],$onee[6]);
            ...
            <h3>Walking</h3>
						...
						<tbody>
                            ...
                            $password = "root@123";
                            $dbname = "nadaa93i_Jrarron";
                          function acceptWalking($pl,$rt,$cat,$imgn,$abt,$poi,$ID,$sr,$ds,$audio) {
                                $_SESSION['place'] = $pl;
                                $_SESSION['rating'] = $rt;
                                $_SESSION['category'] = $cat;
                                $_SESSION['image_name'] = $imgn;
                        ...
                        function rejectWalking($un,$bn,$ID) {
                            $serverna = "localhost";
                            $userna = "nadaa93i_gaurav";
                            $passwo = "root@123";
                            $dbne = "nadaa93i_Jrarron";
                            ...
                            try {
								    ...
								    {              
								        $onee=explode('*', $_POST["accept"]);
								        acceptWalking($onee[0],$onee[3],$onee[1],$onee[2],$onee[4],$onee[5],$onee[6],$onee[7],$onee[8],$onee[9]);
								        
								    }
								    if(isset($_POST["reject"]))
								    {
								        $onee=explode('*', $_POST["reject"]);
								        rejectWalking($onee[0],$onee[1],$onee[6]);
				...
				<h3>Scooter</h3>
						...
						<tbody>
                            ...
                            $password = "root@123";
                            $dbname = "nadaa93i_Jrarron";
                          function acceptScooter($pl,$rt,$cat,$imgn,$abt,$poi,$ID,$sr,$ds,$audio) {
                                $_SESSION['place'] = $pl;
                                $_SESSION['rating'] = $rt;
                                $_SESSION['category'] = $cat;
                                $_SESSION['image_name'] = $imgn;
                        ...
                        function rejectScooter($un,$bn,$ID) {
                            $serverna = "localhost";
                            $userna = "nadaa93i_gaurav";
                            $passwo = "root@123";
                            $dbne = "nadaa93i_Jrarron";
                            ...
                            try {
								    ...
								    {              
								        $onee=explode('*', $_POST["accept"]);
								        acceptScooter($onee[0],$onee[3],$onee[1],$onee[2],$onee[4],$onee[5],$onee[6],$onee[7],$onee[8],$onee[9]);
								        
								    }
								    if(isset($_POST["reject"]))
								    {
								        $onee=explode('*', $_POST["reject"]);
								        rejectScooter($onee[0],$onee[1],$onee[6]);
								    }
                                    }
                                }
                                catch(PDOException $e)
